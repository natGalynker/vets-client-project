...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetPetsById = function onGetPetsById(id) {
	  event.preventDefault();
	  api.getPetsById(id).done(ui.getPetsByIdSuccess).fail(ui.failure);
	};
	...
	var onPatchFeral = function onPatchFeral(id) {
	  var isFeral = true;
	  api.patchFeral(id, isFeral).done(ui.success(id)).fail(ui.failure);
	};

	//grab the id of the pet from the database and change neutered to true
	var onPatchNeutered = function onPatchDeclawed(id) {
	  var isNeutered = true;
	  api.patchDeclawed(id, isNeutered).done(ui.success(id)).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPetsById = function getPetsById(id) {
	  return $.ajax({
	    url: app.api + '/pets/' + id,
	    method: 'GET',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPetsByIdSuccess = function getPetsByIdSuccess(data) {
	  var showPet = __webpack_require__(8);
	  $('#view-pet').modal('show');
	...
	module.exports = {
	  ...
	  getPetsByIdSuccess: getPetsByIdSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"pet-show\">\n<div class=\"pet-values flex-grid-sevenths\">\n  <h5 class=\"col-modal\">\n      Pet Name\n      <span></span>\n      <br>\n      "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.name : stack1), depth0))
	    + "</h5>\n  <h5 class=\"col-modal\">\n      Owner Name\n      <span></span>\n      <br>\n      "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.owner_name : stack1), depth0))
	    + "</h5>\n  <h5 class=\"col-modal\">\n      Date of Birth\n      <span></span>\n      <br>\n      "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.born_on : stack1), depth0))
	    + "</h5>\n  <h5 class=\"col-modal\">\n      Pet Gender\n      <span></span>\n      <br>\n      "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.gender : stack1), depth0))
	    + "</h5>\n  <h5 class=\"col-modal\">\n      Pet Breed\n      <span></span>\n      <br>\n      "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.breed : stack1), depth0))
	    + "</h5>\n</div>\n<hr>\n<div class=\"pet-values flex-grid-sevenths\">\n  <h5 class=\"col-modal\">\n      Neutered\n      <span></span>\n      <br>\n      "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.neutered : stack1), depth0))
	    + "</h5>\n  <h5 class=\"col-modal\">\n      Feral\n      <span></span>\n      <br>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.feral : stack1), depth0))
	    + "</h5>\n  <h5 class=\"col-modal\">\n      Declawed\n      <span></span>\n      <br>\n      "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.declawed : stack1), depth0))
	    + "</h5>\n  <h5 class=\"col-modal\">\n        Vaccinated\n        <span></span>\n        <br>\n        "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.rabes_shot : stack1), depth0))
	    + "\n  </h5>\n</div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class = \"pet-values flex-grid-fifths\">\n    <h3 class=\"col-hbs\">"
	    ...
	    + "</h3>\n</div>\n  <div class=\"button-group flex-grid-fifths\">\n  <form class=\"update-vaccine-form patch-button col-hbs\" data-id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n    <input name=\"submit\" type=\"submit\" class=\"update-vaccinne-btn\" value=\"Got a shot!\">\n  </form>\n    <form class=\"update-feral-form patch-button col-hbs\" data-id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n    <input name=\"pet[feral]\" type=\"submit\" class=\"update-feral-btn\" value=\"Not Feral!\">\n  </form>\n    <form class=\"update-neutered-form patch-button col-hbs\" data-id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n    <input name=\"pet[neutered]\" type=\"submit\" class=\"update-neutered-btn\" value=\"Neutered!!\">\n  </form>\n    <form class=\"update-declawed-form patch-button col-hbs\" data-id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n    <input name=\"pet[declawed]\" type=\"submit\" class=\"update-declawed-btn\" value=\"Declawed!!!\">\n  </form>\n  <form class=\"delete-pet-form patch-button col-hbs\" data-id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n    <input name=\"submit\" type=\"submit\" class=\"delete-pet-btn\" value=\"Remove Pet\">\n  </form>\n</div>\n<li id=\"view-pet\" data-toggle=\"modal\" data-target=\".bs-example-modal-lg\" class=\"nav-button view\" data-id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">View Pet</li>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<div class=\"pet-headers flex-grid-fifths\">\n<h2 class=\"col-hbs\">Pet Name</h2>\n<h2 class =\"col-hbs\">Owner Name</h2>\n<h2 class=\"col-hbs\">Date of Birth</h2>\n<h2 class=\"col-hbs\">Gender</h2>\n<h2 class=\"col-hbs\">Breed</h2>\n</div>\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "d1dd764a3e6e8a6bdfff166349e99f34.jpg";
